...
class TestEcommerceProject(unittest.TestCase):
    ...
    def test_model_training_and_prediction(self):
        texts = ['iphone', 'samsung', 'harry potter', 'wiedźmin'] * 10
        cats = ['Elektronika', 'Elektronika', 'Ksiazki', 'Ksiazki'] * 10
        ...
        self.assertEqual(prediction, "Elektronika")
        
        prediction_book = self.classifier.predict("harry")
        self.assertEqual(prediction_book, "Ksiazki")
